    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 pt-1 sm:pt-2 pb-2 sm:pb-4 flex flex-col lg:flex-row gap-4 sm:gap-6 items-center">
        ...
        <div className="flex-1 text-center lg:text-start pt-0 max-w-2xl">
          ...
          {/* Description */}
          <motion.p className="text-sm sm:text-base text-muted-foreground max-w-lg mb-5 sm:mb-6 leading-relaxed mx-auto lg:mx-0" initial={init} animate={enter} variants={fadeUp} custom={1}>
            {l.heroDesc}
          </motion.p>

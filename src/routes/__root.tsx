...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "hnChat — دردشة ذكية وشبكة تواصل عربية" },
      ...
      { name: "twitter:title", content: "hnChat — دردشة ذكية وشبكة تواصل عربية" },
  ...
  return (
    <html lang="ar" dir="rtl" className="dark">
      <head>
        ...
        {/* HN Backend SDK — hn-bd.online (auto-init via data-site) */}
        <script src="https://hn-bd.online/hn.js" data-site="hn-chat" defer />

...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "hnChat — Super App: AI Chat, Social & Crypto" },
    ...
    links: [
      ...
      { rel: "alternate", hreflang: "en", href: "https://www.hn-chat.com" },
      { rel: "alternate", hreflang: "ar", href: "https://www.hn-chat.com" },
      { rel: "alternate", hreflang: "fr", href: "https://www.hn-chat.com" },
      { rel: "alternate", hreflang: "es", href: "https://www.hn-chat.com" },
      { rel: "alternate", hreflang: "de", href: "https://www.hn-chat.com" },
      { rel: "alternate", hreflang: "x-default", href: "https://www.hn-chat.com" },
    ],
  }),

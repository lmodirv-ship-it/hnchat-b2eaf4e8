...
import { Search, Users, UserCheck, Shield, Crown, Loader2, ChevronLeft, ChevronRight } from "lucide-react";
...
function UsersPage() {
  ...
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      ...
      return { total: total.count ?? 0, verified: verified.count ?? 0, online: online.count ?? 0 };
    },
  });
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-[oklch(0.12_0.03_30)]">
                  {usersData?.users.map((u) => {
                    ...
                    return (
                      <tr key={u.id} className="hover:bg-[oklch(0.08_0.02_30)] transition">
                        <td className="p-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <div className="font-medium text-[oklch(0.9_0.05_50)]">@{u.username}</div>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <OwnerCard className="p-5">
          ...
          {data!.pieData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie data={data!.pieData} cx="50%" cy="50%" innerRadius={45} outerRadius={75} paddingAngle={3} dataKey="value" nameKey="name" label={({ name, percent }) => `${name} ${(percent * 100).toFixed(0)}%`} labelLine={false}>
